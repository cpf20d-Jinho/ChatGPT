...
## 설명
쉬운 ABA는 치료사가 아동별 프로그램과 과제 수행을 기록하고, 지정한 기간의 경과를 살펴보는 iPhone·iPad 앱입니다.
...
## 심사 메모 (영문 초안)
Easy ABA is a record-keeping app for adult practitioners, available on iPhone and iPad. Core records and manually written PDF reports work without an account or an AI key. Trial states are NA (excluded from the denominator), correct (+), and prompted (-). Only completed eligible sessions are included in reports.
