...
- 무료 서버는 영구 보고서 저장소가 아닙니다. 편집 링크는 기본 1시간 후 만료되며 30분씩 연장할 수 있지만 사용자 서버 토큰 만료 시각을 넘길 수 없습니다. 서버 중지·재시작 시 임시본이 더 일찍 없어질 수 있습니다. 상세: `Server/REPORT_WEB_EDITING.md`.
